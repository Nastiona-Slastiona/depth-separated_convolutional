...
predicted = neigh.predict(train_pca)
acc = np.sum(predicted == label_tr)
acc = acc / len(label_tr)
print('Train Accuracy is {}'.format(acc))
print(predicted)
predicted = neigh.predict(cv_pca)
acc = np.sum(predicted == label_cv)
acc = acc / len(label_cv)
print('CV Accuracy is {}'.format(acc))
print(predicted)
predicted = neigh.predict(test_pca)
acc = np.sum(predicted == label_te)
